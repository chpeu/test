...
async def api_get_config():
    """Récupérer la configuration actuelle (valeurs EFFECTIVES)"""
    from utils.effective_config import get_effective_config
    effective = get_effective_config()
    
    return JSONResponse({
        'volume_multiplier': effective.get('volume_multiplier', 0.95),
        'min_score_required': effective.get('min_score_required', 7.5),
        'use_confluence': effective.get('use_confluence', False),
        'tp_sl_mode': effective.get('tp_sl_mode', 'FIXE'),
        'tp_percent': effective.get('tp_percent', 0.25),
        'sl_percent': effective.get('sl_percent', 0.25),
        'trailing_mfe_enabled': effective.get('trailing_mfe_enabled', False),
        'trailing_mfe_trigger_pct': effective.get('trailing_mfe_trigger_pct', 0.10),
        'trailing_mfe_lock_in_pct': effective.get('trailing_mfe_lock_in_pct', 0.0),
        'partial_tp_be_lock_in_pct': effective.get('partial_tp_be_lock_in_pct', 0.0),
        'snr_threshold': effective.get('snr_threshold', 0.25),
        'breakout_threshold': effective.get('breakout_threshold', 0.35),
        'wick_ratio_max': effective.get('wick_ratio_max', 2.8),
        'di_gap_min': effective.get('di_gap_min', 4.0),
        'di_gap_adx_threshold': effective.get('di_gap_adx_threshold', 25),
        'optimal_atr_min_1m': effective.get('optimal_atr_min_1m', 0.12),
        'optimal_atr_max_1m': effective.get('optimal_atr_max_1m', 0.75),
        'optimal_atr_min_5m': effective.get('optimal_atr_min_5m', 0.22),
        'optimal_atr_max_5m': effective.get('optimal_atr_max_5m', 1.4),
        'trend_timeframe': effective.get('trend_timeframe', '15m'),
        'account_size': effective.get('account_size', 1000.0),
        'risk_per_trade': effective.get('risk_per_trade', 2.0),
        'gb_filter_enabled': effective.get('gb_filter_enabled', True),
        'gb_min_confidence': effective.get('gb_min_confidence', 0.55),
        'ml_calibration_enabled': effective.get('ml_calibration_enabled', False),
        'ml_calib_min_winrate': effective.get('ml_calib_min_winrate', 45),
        'ml_calib_live_weight': effective.get('ml_calib_live_weight', 1.0),
        'ml_calib_dryrun_weight': effective.get('ml_calib_dryrun_weight', 0.5),
        'ml_calib_decay_days': effective.get('ml_calib_decay_days', 30),
        'ml_calib_min_trades': effective.get('ml_calib_min_trades', 50),
        'threshold_optimizer_enabled': effective.get('threshold_optimizer_enabled', False),
        'threshold_min': effective.get('threshold_min', 0.45),
        'threshold_max': effective.get('threshold_max', 0.70),
        'drift_detection_enabled': effective.get('drift_detection_enabled', True),
        'gb_max_iter': effective.get('gb_max_iter', 200),
        'gb_max_depth': effective.get('gb_max_depth', 5),
        'gb_learning_rate': effective.get('gb_learning_rate', 0.1),
        'gb_l2_regularization': effective.get('gb_l2_regularization', 0.5),
        'max_spread_pct': effective.get('max_spread_pct'),
        'max_spread_pct_fixe': effective.get('max_spread_pct_fixe', 0.03),
        'max_spread_pct_atr': effective.get('max_spread_pct_atr', 0.06),
        'invert_signals': effective.get('invert_signals', False),
        # Paramètres ATR dynamiques additionnels
        'atr_mult_sl': effective.get('atr_mult_sl'),
        'atr_mult_tp': effective.get('atr_mult_tp'),
        'break_even_atr_mult': effective.get('break_even_atr_mult')
    })
