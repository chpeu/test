...
DEFAULT_REGIME_CONFIGS: Dict[str, RegimeConfig] = {
    "CALME": RegimeConfig(
        ...
        min_score_required=7.5,   # 🔥 BAISSÉ DE 8.5 à 7.5 (Marché difficile)
        atr_mult_sl=0.8,
        atr_mult_tp=1.8,
    ...
    "NORMAL": RegimeConfig(
        ...
        min_score_required=7.0,   # 🔥 BAISSÉ DE 8.0 à 7.0 (Marché difficile)
        atr_mult_sl=1.2,
        atr_mult_tp=2.2,
    ...
    "VOLATILE": RegimeConfig(
        ...
        min_score_required=6.5,   # 🔥 BAISSÉ DE 7.5 à 6.5 (Marché difficile)
        atr_mult_sl=1.5,
        atr_mult_tp=2.5,
    ...
    "CHOPPY": RegimeConfig(
        ...
        min_score_required=9.0,   # 🔥 BAISSÉ DE 10.0 à 9.0 (Marché difficile)
        atr_mult_sl=0.7,
        atr_mult_tp=1.5,
