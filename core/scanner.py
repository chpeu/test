...
class ScalabilityScanner:
    ...
    def calculate_score(self, pair: Dict, max_volume: float, max_depth: float) -> float:
        ...
        # Filtres stricts - 🔥 v6.4.3: Spread entre 0.001% et 0.02%
        ...
        if math.isnan(spread) or spread <= 0.001 or spread > 0.02 or recent_volume < 100000 or balance_score < TRADING_CONFIG['balance_score_min']:
            return 0.0
