#!/usr/bin/env python3
"""
Test Position Manager - Import direct, sans __init__
"""
...
def test_break_even():
    """Test break-even progressif ATR"""
    print("\n=== TEST BREAK-EVEN ATR ===")
    ...
    assert pos.break_even_set, "Break-even devrait être activé"
    assert pos.sl > pos.entry, "SL devrait être > entry après BE 50%"
    print("✅ Break-even validé!")
